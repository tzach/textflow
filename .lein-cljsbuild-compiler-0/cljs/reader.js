...
var self__ = this;
return cljs.core.swap_BANG_.call(null,self__.buffer_atom,(function (p1__3621_SHARP_){
return cljs.core.cons.call(null,ch,p1__3621_SHARP_);
}));
});
...
reader_error.cljs$lang$applyTo = (function (arglist__3622){
var rdr = cljs.core.first(arglist__3622);
var msg = cljs.core.rest(arglist__3622);
...
{{
var G__3623 = (function (){sb.append(ch);
return sb;
})();
var G__3624 = cljs.reader.read_char.call(null,rdr);
sb = G__3623;
ch = G__3624;
continue;
}
...
{{
var G__3625 = cljs.reader.read_char.call(null,rdr);
ch = G__3625;
continue;
}
} else
...
{
var G__3626 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__3626;
continue;
}
} else
...
{
var G__3627 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__3627;
continue;
}
}
...
{{
var G__3628 = (function (){buffer.append(ch);
return buffer;
})();
var G__3629 = cljs.reader.read_char.call(null,reader);
buffer = G__3628;
ch = G__3629;
continue;
}
...
{if(("\\" === ch))
{{
var G__3630 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__3631 = cljs.reader.read_char.call(null,reader);
buffer = G__3630;
ch = G__3631;
continue;
}
...
{if("\uFDD0'default")
{{
var G__3632 = (function (){buffer.append(ch);
return buffer;
})();
var G__3633 = cljs.reader.read_char.call(null,reader);
buffer = G__3632;
ch = G__3633;
continue;
}
...
if((function (){var G__3635 = o;
if(G__3635)
{if((function (){var or__3824__auto__ = (G__3635.cljs$lang$protocol_mask$partition0$ & 262144);
if(or__3824__auto__)
{return or__3824__auto__;
} else
{return G__3635.cljs$core$IWithMeta$;
}
})())
{return true;
} else
{if((!G__3635.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.IWithMeta,G__3635);
} else
{return false;
}
}
...
{{
var G__3636 = reader;
var G__3637 = eof_is_error;
var G__3638 = sentinel;
var G__3639 = is_recursive;
reader = G__3636;
eof_is_error = G__3637;
sentinel = G__3638;
is_recursive = G__3639;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__3640 = cljs.reader.read_comment.call(null,reader,ch);
var G__3641 = eof_is_error;
var G__3642 = sentinel;
var G__3643 = is_recursive;
reader = G__3640;
eof_is_error = G__3641;
sentinel = G__3642;
is_recursive = G__3643;
continue;
}
} else
{if("\uFDD0'else")
...
{{
var G__3644 = reader;
var G__3645 = eof_is_error;
var G__3646 = sentinel;
var G__3647 = is_recursive;
reader = G__3644;
eof_is_error = G__3645;
sentinel = G__3646;
is_recursive = G__3647;
continue;
}
} else
{return res;
...
{var vec__3653 = temp__3974__auto__;
var vec__3654 = cljs.core.nth.call(null,vec__3653,0,null);
var _ = cljs.core.nth.call(null,vec__3654,0,null);
var years = cljs.core.nth.call(null,vec__3654,1,null);
var months = cljs.core.nth.call(null,vec__3654,2,null);
var days = cljs.core.nth.call(null,vec__3654,3,null);
var hours = cljs.core.nth.call(null,vec__3654,4,null);
var minutes = cljs.core.nth.call(null,vec__3654,5,null);
var seconds = cljs.core.nth.call(null,vec__3654,6,null);
var milliseconds = cljs.core.nth.call(null,vec__3654,7,null);
var vec__3655 = cljs.core.nth.call(null,vec__3653,1,null);
var ___$1 = cljs.core.nth.call(null,vec__3655,0,null);
var ___$2 = cljs.core.nth.call(null,vec__3655,1,null);
var ___$3 = cljs.core.nth.call(null,vec__3655,2,null);
var V = vec__3653;
var vec__3656 = cljs.core.map.call(null,(function (v){
return cljs.core.map.call(null,(function (p1__3652_SHARP_){
return parseInt(p1__3652_SHARP_,10);
}),v);
}),cljs.core.map.call(null,(function (p1__3650_SHARP_,p2__3649_SHARP_){
return cljs.core.update_in.call(null,p2__3649_SHARP_,cljs.core.PersistentVector.fromArray([0], true),p1__3650_SHARP_);
}),cljs.core.PersistentVector.fromArray([cljs.core.constantly.call(null,null),(function (p1__3651_SHARP_){
if(cljs.core._EQ_.call(null,p1__3651_SHARP_,"-"))
{return "-1";
} else
{return "1";
}
...
var ___$4 = cljs.core.nth.call(null,vec__3657,0,null);
var y = cljs.core.nth.call(null,vec__3657,1,null);
var mo = cljs.core.nth.call(null,vec__3657,2,null);
var d = cljs.core.nth.call(null,vec__3657,3,null);
var h = cljs.core.nth.call(null,vec__3657,4,null);
var m = cljs.core.nth.call(null,vec__3657,5,null);
var s = cljs.core.nth.call(null,vec__3657,6,null);
var ms = cljs.core.nth.call(null,vec__3657,7,null);
var vec__3658 = cljs.core.nth.call(null,vec__3656,1,null);
var offset_sign = cljs.core.nth.call(null,vec__3658,0,null);
var offset_hours = cljs.core.nth.call(null,vec__3658,1,null);
var offset_minutes = cljs.core.nth.call(null,vec__3658,2,null);
...
if(cljs.core.truth_(temp__3971__auto__))
{var vec__3660 = temp__3971__auto__;
var years = cljs.core.nth.call(null,vec__3660,0,null);
var months = cljs.core.nth.call(null,vec__3660,1,null);
var days = cljs.core.nth.call(null,vec__3660,2,null);
var hours = cljs.core.nth.call(null,vec__3660,3,null);
var minutes = cljs.core.nth.call(null,vec__3660,4,null);
var seconds = cljs.core.nth.call(null,vec__3660,5,null);
var ms = cljs.core.nth.call(null,vec__3660,6,null);
var offset = cljs.core.nth.call(null,vec__3660,7,null);
